  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        justifyContent: 'flex-end', padding: '64px 48px',
      }}>
        <div style={{
        ...
        <h1 style={{
          fontFamily: 'var(--serif)', fontSize: 'clamp(48px, 6vw, 80px)',
      ...
      <div style={{ position: 'relative', overflow: 'hidden', background: 'var(--sand)' }}>
        <div style={{
