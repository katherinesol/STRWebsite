...
export default function PropertyTabs({ id, name, active }: { id: string; name: string; active: 'content' | 'places' | 'photos' | 'guides' | 'pricing' }) {
  const tabs = [
    ...
    { key: 'guides', label: 'Guide', href: `/keyholder/property/${id}/guides` },
