...
export default async function PlatformBookingPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <BookingDetail kind="platform" canDeleteMedia={canDeleteMedia} canViewDamage={canViewDamage} canEditDamage={canEditDamage} siteUrl={process.env.NEXT_PUBLIC_SITE_URL || "https://rental-direct-five.vercel.app"} accounts={accounts || []} {...d} />
}
